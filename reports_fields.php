...
<div align='center' style='font-family: Arial; font-size: 12pt; color: #0066FF; font-weight: bold'>
   ...
   REPORT NAME:&nbsp;<input type='text' name='ReportName'  value="" required='required' style='width: 150; height: 20; font-family: Arial; border: 1px solid #E0E0E0; padding: 2; background-color:#FFFFDF'>   
   <input type='submit' value='Create Report' name='Save' ></font> <font face='Arial'>
   <input type='button' value='Start Over' onClick='javascript:location.reload()' name='refresh'></font></b>
   <input type='button' value='Close' onclick="window.open('reports.php','_mainframe');" name='refresh'></font></b>
<hr> 
...
echo "<td align='left'>
         <input type='checkbox' name='F1[]' value='$line'       style='width: 19; height: 15;' >
         <input type='hidden'   name='F2[]' value='$_GET[q]'    size='26' style='width: 100; height: 15; font-size: 8pt; font-family: Tahoma; border: 0px solid #E0E0E0; padding: 1' >        
         <input type='text'     name='F3[]' value='$meta[name]' size='26' style='width: 100; height: 15; font-size: 8pt; font-family: Tahoma; border: 0px solid #E0E0E0; padding: 1' >
         <input type='hidden'   name='F4[]' value='$CreateFormId'   size='26' style='width: 100; height: 15; font-size: 8pt; font-family: Tahoma; border: 0px solid #E0E0E0; padding: 1' >
...
echo "<td align='left'>
         ...
         <input type='hidden' name='F2[]' value='$_GET[q]'      style='width: 100; height: 15; font-size: 8pt; font-family: Tahoma; border: 0px solid #E0E0E0; padding: 1' >        
         ...
         <input type='hidden' name='F4[]' value='$CreateFormId' style='width: 100; height: 15; font-size: 8pt; font-family: Tahoma; border: 0px solid #E0E0E0; padding: 1' >
         </td>";
